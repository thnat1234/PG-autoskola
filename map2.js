...
function map2() {
    ...
    var createScene = function () {
        ...
        var ground2 = BABYLON.Mesh.CreateGround("ground2", 100, 100, 2, scene2);
        ...
        scene2.registerBeforeRender(function () {
            ...
            var curbFinish = scene2.getMeshByName("collider_curb.013");
            ...
            cars.forEach(element => {
                carsMeshes.push(scene2.getMeshByName(element));
            });
    ...
    var makePhysicsObject = (newMeshes, scene, scaling) => {
        ...
        var physicsRoot = new BABYLON.Mesh("physicsRoot" + level, scene);
